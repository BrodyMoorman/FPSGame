...
@export var ROLL_ACCELERATION_DELTA: float = 0.2
@export var ROLL_DECELERATION_DELTA: float = 0.1
@export var TILT_LOWER_LIMIT = deg_to_rad(-90.0)
@export var TILT_UPPER_LIMIT = deg_to_rad(90.0)
@export var CAMERA_CONTROLLER : Node3D
@export var ANIMATIONPLAYER: AnimationPlayer
@export var CROUCH_SHAPECAST: Node3D
@export var GLOCK: Node3D
...
func _ready():
	...
	# crouchcheck shapecast collision exception for CharacterBody3d node
...
func _physics_process(delta):
	...
	if direction:
		...
		velocity.x = move_toward(velocity.x, direction.x * _speed, ROLL_ACCELERATION_DELTA)
		velocity.z = move_toward(velocity.z, direction.z * _speed , ROLL_ACCELERATION_DELTA)
	else:
		velocity.x = move_toward(velocity.x, 0, ROLL_DECELERATION_DELTA)
		velocity.z = move_toward(velocity.z, 0, ROLL_DECELERATION_DELTA)
